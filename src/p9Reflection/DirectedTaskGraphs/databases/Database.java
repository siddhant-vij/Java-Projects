package p9Reflection.DirectedTaskGraphs.databases;
...
public class Database {
  private Map<String, List<Float>> GAME_TO_RATINGS_PRICE = Map.of(
  ...
  public Set<String> readAllGames() {
    return Collections.unmodifiableSet(GAME_TO_RATINGS_PRICE.keySet());
  }

  public Map<String, Float> readGameToRatings(Set<String> games) {
    return GAME_TO_RATINGS_PRICE.entrySet()
        .stream()
